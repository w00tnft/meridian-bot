/**
 * One-time sweep script for unattended execution (Railway Cron Job).
 * Sweeps all SOL from Meridian's wallet to the destination address.
 * Prints a 10-second countdown then executes automatically — no CONFIRM required.
 * Usage: node scripts/sweep-cron.js
 */
